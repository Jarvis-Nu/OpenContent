...
export default function Hero() {
    return(
        <div className="w-full bg-dark h-full px-[25px] sm:px-[50px] lg:px-[100px] xl:px-0 space-y-5 text-center pb-5 sm:pb-24 flex flex-col items-center">
            <div className="space-y-5 flex flex-col lg:flex-row lg:items-center lg:justify-between lg:space-y-0 lg:space-x-5 xl:space-x-16 max-w-6xl">
                <div className="text-center lg:text-start space-y-5 lg:max-w-md xl:max-w-xl">
                    <p className="text-red text-sm sm:text-base tracking-wide pt-5 font-[500]">The Decentralized Solution</p>
                    <h3 className="text-white">Secure Your Content with OpenContent</h3>
                    <p className="text-ash text-[14px] font-[500]">
