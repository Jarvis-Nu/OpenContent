...
export default function WaitList() {
    return(
        <div className="w-full px-[25px] sm:px-[50px] lg:px-[100px] py-4 sm:py-6 md:py-8 lg:py-10 flex justify-center">
            <div className="w-full max-w-6xl px-5 py-10 bg-black rounded-md md:pr-0 md:pl-10">
                <div className="flex flex-col items-center w-full md:flex-row">
                    <div className="w-full h-full max-w-xl space-y-3 xl:space-y-5 sm:pr-2.5 lg:pr-0">
                    ...
                    <div className="relative hidden w-full h-64 md:block">
