...
export default function Header() {
    return(
        <div className="w-full text-white relative bg-dark">
            <div className="z-20 relative">
                <div className="w-full px-[25px] sm:px-[50px] lg:px-[100px] py-4 sm:py-6 md:py-8 lg:py-10 flex justify-between items-center bg-dark">
                    <motion.div
                        initial={{
                            x: -500,
                            opacity: 0,
